...
; ==================================================================
	...
	%DEFINE MASTEROS_VER '4.1'	; OS version number
	%DEFINE MASTEROS_API_VER 13	; API version for programs to check
...
option_screen:
	...
	os_init_msg		db 'Welcome to MasterOS', 0
	os_version_msg		db 'Version ', MASTEROS_VER, 0

	dialog_string_1		db 'Thanks for trying out MasterOS!', 0
